...
// GetSchemeSnapshot returns with the actual db scheme.
// used for testing.
func (db *DB) GetSchemeSnapshot(ctx context.Context) (*dbschema.Snapshot, error) {
	return pgutil.QuerySnapshot(ctx, db.db)
}
