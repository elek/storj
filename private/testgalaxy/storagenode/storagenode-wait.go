...
func (planet *testplanet.Planet) WaitForStorageNodeEndpoints(ctx context.Context) (err error) {
	defer testplanet.mon.Task()(&ctx)(&err)
...
func (planet *testplanet.Planet) storageNodeLiveRequestCount() int {
	total := 0
...
func (planet *testplanet.Planet) WaitForStorageNodeDeleters(ctx context.Context) {
	defer testplanet.mon.Task()(&ctx)(nil)
